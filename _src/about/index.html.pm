...
◊define-meta[description]{Learn about Shane Logsdon, the polyglot web developer.}

◊a[#:href "mailto:shane@shanelogsdon.com"]{Email}
◊span[#:class "separator"]{•}
◊a[#:href "/about/resume/index.pdf"]{Resume}

◊h2{Short Version}

I'm a polyglot web developer. Current interests include Elixir/Erlang, Go, Haskell, Lua, and DevOps when necessary.

I have limited availability for contract projects and am currently not looking for new full-time opportunities. ◊a[#:href "mailto:shane@shanelogsdon.com"]{Send me an email} if you'd like to discuss a project with me.
