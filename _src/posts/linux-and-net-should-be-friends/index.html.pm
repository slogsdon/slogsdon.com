...
◊ol{
  ◊li{It's fast thanks to the precompiled nature of .NET.}
  ◊li{Visual Studio.}
  ◊li{We focus on development with .NET at work.}
}

I like speed. I have spent hours upon hours configuring Varnish and nginx as reverse-proxy caches on various servers. I am even porting WordPress functionality into a plugin for ◊a[#:href "https://github.com/slogsdon/unamed"]{another CMS} to speed up the software. Both of these (plus loads more) all in the name of speed.
